...
- Learn the style of the original wallet (their token style, the entry/exit price,...)
- Settings Minimum Market Cap: **5M**
- Settings Minimum Jupiter Organic Score: **50**
- Copy wallet that have avg position age **> 20 mins (0.3hrs)**
- Set **Stop loss at 15%**
- Start small, increase when you feel confidence
