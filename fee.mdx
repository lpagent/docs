...
Our new pricing model is simple: you only pay when you earn.
...
<CardGroup cols={2}>
  ...
  <Card title="Earnings Fee" icon="coins">
    <div className="mt-2">
      <span className="text-2xl font-bold text-primary">
        8% on Earnings Only
      </span>
      <div className="mt-2 text-sm">
        Fee only applied to your actual profits from LP fees.
      </div>
    </div>
  </Card>
</CardGroup>
...
**Example:** Your position earns \$100 in LP fees over time. LP Agent takes 8% of those earnings (\$8), and you keep \$92. If your position doesn't earn any fees, you pay nothing at all.
