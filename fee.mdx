...
<Note>
  Our main fee is 8% on your actual earnings - no upfront costs, no swap fees.
  ...
  <Card title="Swap Fee" icon="percent">
    <div className="mt-2">
      ...
      <div className="mt-2 text-sm">
        No swap fee when opening or closing positions. Manual zap in/out carries a small 0.1% fee.
      </div>
    </div>
  </Card>
...
<Warning>
  The 8% applies when positions are handled by auto take-profit / stop-loss;
  manual zap in/out uses a 0.1% fee instead. Normal protocol fees (like network
